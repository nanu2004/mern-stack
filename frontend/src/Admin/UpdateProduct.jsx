...
const UpdateProduct = () => {
  ...
  const [price, setPrice] = useState(0); // Initialize price as number
  const [category, setCategory] = useState("");
  const [quantity, setQuantity] = useState(0); // Initialize quantity as number
  const [shipping, setShipping] = useState(false); // Initialize shipping as boolean
  const [photo, setPhoto] = useState(null); // Initialize photo as null
